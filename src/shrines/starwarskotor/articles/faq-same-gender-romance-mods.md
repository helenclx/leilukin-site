...
{% qna 'I am having problems with your mod / I cannot get your mod to work / Your mod does not work for me.' %}
...
{% qna 'When I installed your mod, I got the error message: <i>"[ERROR] Unhandled exception: Access violation at address [a bunch of numbers]. Write of address [a bunch of numbers] (0)"</i>.' %}
...
{% qna 'When installing your <cite>KotOR 2</cite> mod, I got "Destination file <i>"Modules\[____].mod" does not exist at the specified location! Skipping section... [Error]"</i> and other similar errors, even though I had installed the installer (.exe) version of The Sith Lords Restored Content Mod.' %}
...
{% qna 'Will you upload your mods to Steam Workshop?' %}
...
{% qna 'I am having problems a <cite>KotOR 2</cite> mod of yours, and I am using the Steam Workshop. Can you help me?' %}
...
{% qna 'Does this mod work with [insert a different mod here]?' %}
...
{% qna "Are your romance mods compatible with [KotOR Community Portal's mod builds](https://kotor.neocities.org/modding/){target='_blank'}?" %}
Yes, all my mods are compatible with KotOR Community Portal's mod builds.
...
{% qna 'Can I use your mods with non-English localizations of the <cite>KotOR</cite> games and The Sith Lords Restored Content Mod (TSLRCM)?' %}
...
{% qna 'For your <cite>KotOR 2</cite> mods that require The Sith Lords Restored Content Mod (TSLRCM) to work, will you make an alternate version that does not require TSLRCM?' %}
...
{% qna 'How to install your mods on the Xbox/Android/iOS/Nintendo Switch/any other non-PC version of <cite>KotOR</cite> or <cite>KotOR 2</cite>?' %}
...
{% qna 'Will you add kissing scenes to your romance mods?' %}
...
{% qna 'Will you make a romance mod for Canderous/Bao-Dur/Mira/any other character with no romance content in the vanilla game?' %}
...
{% qna 'Why do you make everyone gay?' %}
...
{% qna 'Character X being gay does not fit his/her character.' %}
...
{% qna 'Will you make Juhani a romance option for male Revan too in Alternate Revan Romances REDUX?' %}
**No**. I will **_never_** make Juhani a romance option for male characters under _any_ circumstances. I also do not support any mods that make Juhani a romance option for male characters.
...
{% qna 'The AI-generated voice for Juhani in the Juhani cameo add-on is robotic.' %}
...
{% qna 'I am using your Handmaiden romance mod while playing as a female player character, but Handmaiden does not join my party after I leave the Telos Academy!' %}
...
{% qna "For your Handmaiden/Disciple romance mod, can you make it so you always recruit Handmaiden or Disciple only regardless of the Exile's gender?" %}
...
{% qna 'I am using your Handmaiden romance mod, but I cannot spar with the Handmaiden when she joins my party!' %}
